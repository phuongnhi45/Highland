...
class tinkhuyenmai extends Component {
  render() {
    return (
      <div className="tin">
        ...
        <div className="newss">
          ...
          <div className="main-news">
            <a className="anh" href="/chi-tiet-tin-tuc"><img src="https://www.highlandscoffee.com.vn/vnt_upload/news/11_2018/thumbs/470_crop_1.1.png" alt="news" /></a>
            <div className="cap"><a href="/chi-tiet-tin-tuc">SƯU TẦM THẺ CÀO TỰ HÀO: “KẾT NỐI VIỆT NAM, VI VU BIỂN NGỌC”</a></div>
            <div className="date"><i className="fa fa-calendar-o" aria-hidden="true" /><p>14/11/2018, 08:00</p></div>
          </div>
          <div className="main-news">
            <a className="anh" href="/chi-tiet-tin-tuc"><img src="https://www.highlandscoffee.com.vn/vnt_upload/news/07_2018/thumbs/470_crop__IV_0304.jpg" alt="news" /></a>
            <div className="cap"><a href="/chi-tiet-tin-tuc">TẬN HƯỞNG HƠN CÙNG SỔ KHUYẾN MÃI FREEZE TRÀ XANH</a></div>
            <div className="date"><i className="fa fa-calendar-o" aria-hidden="true" /><p>28/10/2019, 12:05</p></div>
          </div>
          <div className="main-news">
            <a className="anh" href="/chi-tiet-tin-tuc"><img src="https://www.highlandscoffee.com.vn/vnt_upload/news/05_2018/thumbs/470_crop__IV_8154.jpg" alt="news" /></a>
            <div className="cap"><a href="/chi-tiet-tin-tuc">TẶNG 1 LY PHIN SỮA ĐÁ KHI SƯU TẬP ĐỦ 3 TEM</a></div>
