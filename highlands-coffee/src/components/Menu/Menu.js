      ...
      <section>
        <div className="thucdon" style={{backgroundImage: 'url(https://www.highlandscoffee.com.vn/vnt_upload/product/04_2018/menu-PSD-bg.jpg)'}}>
          <div className="col-lg-6">
            <Link to="/ca-phe" className="tieude1">cà phê</Link>
            ...
            <Link to="/ca-phe"><button type="button" id="one" className="btn btn-outline-warning btn-lg">khám phá thêm</button></Link>
          </div>
          <div className="col-lg-6">
        ...
        <div className="thucdon" style={{backgroundImage: 'url(https://www.highlandscoffee.com.vn/vnt_upload/product/04_2018/menu-FREEZE.jpg)', textAlign: 'right', paddingRight: '115px'}}>
          ...
          <div className="col-lg-6">
            <Link to="/da-xay" className="tieude2">freeze</Link>
            ...
            <Link to="/da-xay"><button type="button" id="two" className="btn btn-outline-warning btn-lg">khám phá thêm</button></Link>
          </div>
        </div>
        <div className="thucdon" style={{backgroundImage: 'url(https://www.highlandscoffee.com.vn/vnt_upload/product/04_2018/menu-TEA-bg.jpg)'}}>
          <div className="col-lg-6">
            <Link to="/tra" className="tieude3">trà</Link>
            ...
            <Link to="/tra"><button type="button" id="three" className="btn btn-outline-warning btn-lg">khám phá thêm</button></Link>
          </div>
          <div className="col-lg-6">
        ...
        <div className="thucdon" style={{backgroundImage: 'url(https://www.highlandscoffee.com.vn/vnt_upload/product/03_2018/menu-BANHMI-bg_2.jpg)', marginBottom: '-2px', top: '-2px', textAlign: 'right', paddingRight: '58px'}}>
          ...
          <div className="col-lg-6">
            <Link to="/banh-mi" style={{color:'#ffffe0'}} className="tieude2">bánh mì</Link>
            ...
            <Link to="/banh-mi"><button type="button" id="four" className="btn btn-outline-warning btn-lg">khám phá thêm</button></Link>
          </div>
        </div>
      </section>
    );
